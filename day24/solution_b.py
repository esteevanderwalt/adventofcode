...
if __name__ == '__main__':
    get_results("P1 Example", part1, read_line_blocks, "input_test.txt", expected=4)
    get_results("P1 Example Larger", part1, read_line_blocks, "input_test2.txt", expected=2024)
