...
# Full script runs in ~6 ms. Part 1 was easy enough. For part 2 the main idea is to look 
# for seconds for which row positions and column positions of robots have low variance, 
# indicating some kind of clustering which likely is the christmas tree. More comments in code.